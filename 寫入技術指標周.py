...
def main( ):
    ...
    db_W = DB_TechAnalysis( ip, 'mysql', 'pregaine', 'RF69xy7C' )
    ...
    stock_W = { '周': [ db_W, '_周線技術指標.csv' ] }

    # path = '/home/wenwei/下載/Tech/技術指標/week/'
    
    path = '/home/pi/Downloads/技術指標/week/'

    # 讀取資料夾
    for file in glob( '{}*_周線技術指標.csv'.format( path ) ):
