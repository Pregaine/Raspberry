...
class Lend:
    ...
    def GetDate( self, date_str ):
        ...
        self.df[ '借券賣出次一營業日可限額' ] = self.df[ '借券賣出次一營業日可限額' ].str.replace( ',', '' ).astype( int )
...
def GetFile( BdateObj, EdateObj ):
    ...
    while BdateObj > EdateObj:
        ...
        file_name = './借還卷/捉取借卷_{}.csv'.format( date )
...
def main( ):
        ...
        EdateObj = datetime.today( ) - timedelta( days = 120 )
