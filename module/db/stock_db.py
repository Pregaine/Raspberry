...
class Handle:
    ...
    def CreateTable_BrokerageAvgPrice( self ):
        ...
        cmd = ''' 
        CREATE TABLE mysql.BrokerageAvgPrice
        (
    ...
    def WriteData( self, data ):
        ...
        var_string = ', '.join( ['%s'] * ( len( data )  ) )
        cmd = 'INSERT INTO {} VALUES ( {} )'.format( self.table, var_string )

        # try:
        self.cur_db.execute( cmd, data )
        self.stock = data[ 0 ]
        self.date = data[ 1 ]
        self.con_db.commit( )
